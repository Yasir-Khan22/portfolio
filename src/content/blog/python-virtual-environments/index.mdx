...
<h1 style={{fontWeight:"bold", fontSize: "30px"}}> 1. Using `venv` </h1>
...
2. <h3 style={{fontSize: "20px", fontWeight: "medium"}}>Activate the virtual environment:</h3>
...
<h2 style={{fontSize: "30px", fontWeight: "bold"}}> 2. Using "virtualenv" </h2>
...
Create a virtual environment: Specify the version of Python you want:
